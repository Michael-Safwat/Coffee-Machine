...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'E:\Programming\Angela's Python Course\Coffee-Machine-Project'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'E:\Programming\Angela's Python Course\Coffee-Machine-Project\Scripts\deactivate.nu'
